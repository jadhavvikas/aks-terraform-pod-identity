...
variable "azure_ad_admin_groups" {
  ...
  type        = list(string)
  default     = ["ENTER OBJECT ID FOR AAD GROUP"]
...
variable "lb_api_record" {
  description = "Record Name to creating in DNS zone to link Ingress LB IP"
  default     = "demo"
}

variable "dns_zone_name" {
  description = "Name of EXISTING EXISTING DNS Zone"
  default = "aks-demo-aad-kv.io"
}

variable "dns_zone_rg" {
  description = "RG of EXISTING DNS Zone"
  default = "demo-apps"
}
